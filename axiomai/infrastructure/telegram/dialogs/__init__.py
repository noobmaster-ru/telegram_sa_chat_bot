...
from axiomai.infrastructure.telegram.dialogs.refill_balance import refill_balance_dialog
...
def setup(dispatcher: Dispatcher) -> None:
    ...
    router.include_routers(
        create_cashback_table_dialog,
        my_cabinet_dialog,
        cashback_article_dialog,
        buy_leads_dialog,
        refill_balance_dialog,
    )
