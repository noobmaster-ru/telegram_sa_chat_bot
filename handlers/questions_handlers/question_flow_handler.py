...
from handlers.questions_handlers.question_product_ordered_handler import ask_is_product_ordered_question
...
#     """Запускает пошаговый опрос покупателя."""
    ...
    await ask_is_product_ordered_question(message, spreadsheet, BUYERS_SHEET_NAME, state)
...
#     await state.set_state(UserFlow.waiting_for_order_confirmation)
