...
from handlers.questions_handlers.question_feedback_done_handler import ask_is_feedback_done_question
...
async def handle_question_answer(
    ...
    await ask_is_feedback_done_question(callback.message, spreadsheet, BUYERS_SHEET_NAME, state)
    await callback.answer()