...
MIN_LEN_TEXT = 12
FIRST_MESSAGE_DELAY_SLEEP = 60 # 0.4#  in production 
DELAY_BEETWEEN_BOT_MESSAGES_IN_FIRST_HANDLER = 5 #0.4# in production
TIME_DURATION_BEETWEEN_REMINDER =  3600*12 #60# in production
TIME_DURATION_BEETWEEN_REMINDER_ORDER_RECEIVE = 3600*23 # 60# in production
TIME_DELTA_CHECK_LAST_USERS_ACTIVITYS = 3600  # 60#in production - every hour check users last time activitys
