...
MIN_LEN_TEXT = 12
FIRST_MESSAGE_DELAY_SLEEP = 0.4# 60 #  in production 
DELAY_BEETWEEN_BOT_MESSAGES_IN_FIRST_HANDLER = 0.4# 5 #in production
...
# Google Sheets
TIME_DELTA_CHECK_GOOGLE_SHEETS_SELLER_DATA_UPDATE = 120 # every 2 minutes check updates from seller's google sheets
